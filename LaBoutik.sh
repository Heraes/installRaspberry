...
rm /home/sysop/installRaspberry/LaBoutik.sh
...
if echo "$nfc" | grep -i "usb"; then
    ...
    ###TODO modifier le fichier serveur_nfc.js###
    #sed -i 's|import { deviceEmitter } from "./jsModules/devices/vma405.js";|//import { deviceEmitter } from "./jsModules/devices/acr122u.js";|' "/home/sysop/serveurNfcNodeJs/serveur_nfc.js" 
### fin usb

echo "----- cas lecteur NFC GPIO"
###cas GPIO
elif echo "$nfc" | grep -i "gpio"; then
    #sed -i 's|import { deviceEmitter } from "./jsModules/devices/acr122u.js";|//import { deviceEmitter } from "./jsModules/devices/acr122u.js";|' "/home/sysop/serveurNfcNodeJs/serveur_nfc.js" 
...
# chown sysop:sysop /home/sysop/serveurNfcNodeJs.7z

# echo "----- décompresser le fichier serveurNfcNodeJs.7z"
# #décompresser le fichier serveurNfcNodeJs.7z
# if [ -d /home/sysop/serveurNfcNodeJs ]; then
#     # Le répertoire existe
#     echo "----Effacement du repertoire"
#     rm -r /home/sysop/serveurNfc
#     7z x /home/sysop/serveurNfcNodeJs.7z -o/home/sysop/
# else
#     echo "----Decompression serveurNfcNodeJs.7z"
#     7z x /home/sysop/serveurNfcNodeJs.7z -o/home/sysop/
# fi
